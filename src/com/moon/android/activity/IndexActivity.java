...
import com.mooncloud.android.hdtv.R;
...
public class IndexActivity extends Activity {
    ...
    private ForceTV ftv=new ForceTV();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(){
			@Override
			public void run() {
				ftv.initForceClient();//not execute this,couldn't play video,keeping on loading video state
			}
		}.start();
